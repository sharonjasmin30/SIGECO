          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Creación usuario profesor</h1>
              </div>
                ...
                <form class="user">
                  ...
                  <a href="login.html" class="btn btn-primary btn-user btn-block">Registrar Profesor</a>
                  <a href="login.html" class="btn btn-danger btn-user btn-block">Cancelar</a>
                </form>
            </div>
          </div>
        </div>
