              ...
              <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Generar Boletas de Impresión</h6>
                    </div>
                    ...
                    <form>
                        ...
                        <div class="col-md-12">
                                    ...
                                    <label >Para poder generar las boletas de los alumnos debe de
                                    Cerrar su registro correspondiente a cada Curso de<br> cada Periodo, una vez cerrado
                                    el registro no podrá realizar ningun cambio en las notas de los alumnos.<br> ¿Desea Continuar?</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-primary">Generar y Cerrar</button>
                            <br>
                            <br>
                        </div>
                    </form>
